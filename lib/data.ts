import type { User, SubscriptionPlan, TradingScript, EducationContent, MarketIndex, MentorshipPackage } from "./types"
...
export const subscriptionPlans: SubscriptionPlan[] = [
  {
    name: "Diamond",
    price: "$49/mo",
    features: ["Basic Market Analysis", "Standard Trading Tools", "Community Forum Access", "Email Support"],
...
export const marketIndices: MarketIndex[] = [
  ...
  { symbol: "RUSSELL 2K", price: "2,022.03", change: "+0.43%", isPositive: true },
...
export const eagleAcademyCategories: import("./types").AcademyCategory[] = [
  {
    name: "Start Trading",
    videos: [
      { id: "v001", title: "Broker / Trading Platform Comparison", videoId: "0Yy3-ph0kS0" },
      { id: "v002", title: "Introduction to the Stock Market", videoId: "cDf0HgMYf_I" },
      { id: "v003", title: "Investment & Trading Products", videoId: "ypfiThp7WoQ" },
      { id: "v004", title: "Stocks vs ETF's Comparison", videoId: "LfE-_gIMeLg" },
      { id: "v005", title: "Long Term Investing Tutorial", videoId: "GoELOuINJAI" },
      { id: "v006", title: "Best Practices", videoId: "oQJgu7cVYME" },
      { id: "v007", title: "Day vs Swing Trading Comparison", videoId: "Q7HNDrkxYcM" },
    ],
  },
  {
    name: "Fundamental Analysis",
    videos: [
      { id: "v008", title: "Developing Market Awareness", videoId: "N1atMOhNzwg" },
      { id: "v009", title: "Macroeconomics", videoId: "0H7LjVnrsQ8" },
      { id: "v010", title: "Market & Sector Rotations", videoId: "gWNXdV0Ch10" },
      { id: "v011", title: "Global Markets & Exchanges", videoId: "4Ft21q9Juv8" },
    ],
  },
  {
    name: "Technical Analysis",
    videos: [
      { id: "v012", title: "Introduction to Technical Analysis", videoId: "oa7Ig97N_ug" },
      { id: "v013", title: "Technical Analysis Patterns - Essentials", videoId: "1h3b2XXbVp8" },
      ...
      { id: "v017", title: "Elliot Wave Part 2 + Fibonacci", videoId: "yh7ZdpzkZCA" },
    ],
  },
  {
    ...
    videos: [
      ...
      { id: "v019", title: "Portfolio Management Introduction", videoId: "SZVtmfW6EF0" },
      { id: "v020", title: "Dollar Cost Averaging (DCA)", videoId: "7rhCvS3GtN0" },
      { id: "v021", title: "Diversification, Hedging, Risk Management - Essential", videoId: "WW53e2qm1iA" },
  ...
  },
  {
    ...
    videos: [
      { id: "v023", title: "Single Leg Options (Calls & Puts)", videoId: "8DesS7-s2KE" },
      { id: "v024", title: "Multi Leg Options (Spreads)", videoId: "Np0Yh3WPghc" },
      { id: "v025", title: "Option Sizing - Essential", videoId: "FaLpR_o4Vow" },
  ...
  },
  {
    ...
    videos: [
      { id: "v028", title: "Day Trading Strategy Tutorial 1", videoId: "JnkdupmZ0Eo" },
      { id: "v029", title: "Day Trading Strategy Tutorial 2", videoId: "cp6L40JpOMw" },
      { id: "v030", title: "Option Day Trading Tutorial", videoId: "CB4Z3yMXct0" },
    ],
  },
  {
    name: "Cryptocurrency",
    videos: [
      ...
      { id: "v032", title: "Trading & Investing with Crypto", videoId: "uQtLLY6ctog" },
    ],
  },
]
