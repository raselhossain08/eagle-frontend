// Updated contracts manager that uses dynamic templates from dashboard backend
"use client";
...
import { Download, FileText, Calendar, CreditCard, Plus, Search, Eye } from "lucide-react";
...
export function EnhancedContractsManager() {
