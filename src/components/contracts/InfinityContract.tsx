...
export const InfinityContract: React.FC<InfinityContractProps> = ({
  customerName,
  contractDate,
  price,
  preview = false,
    ...
    <div className="contract-container text-white  text-sm space-y-4">
      ...
      <div className="border-b border-slate-600 pb-4">
        ...
        <p className="indent mt-2">
          Eagle Investors LLC's investment advice is non-discretionary as the firm does not make investment decisions on the client's behalf. Rather, the firm provides impersonal recommendations and guidance, leaving the final decision-making process and execution to the client. This non-discretionary advice is available to our Subscribers via ongoing fee-based subscription. Due to the client maintaining full control of their accounts, it is the client's decision if they want to impose restrictions on investing in certain securities or types of securities.
        </p>
        <p className="indent mt-2">
      ...
      <div className="border-b border-slate-600 pb-4">
        ...
        <p className="indent">
          This contract shall commence on <span className="underline">{contractDate}</span> and shall renew on a monthly or annual basis, depending on the client's selected subscription plan, unless sooner terminated as provided herein.
        </p>
      </div>
      ...
      <div className="border-b border-slate-600 pb-4">
        ...
        <p className="indent">
          The Fee will range from $127 monthly to $1,270 annually (not a % or for management but for the subscription). The fee includes recommendations of digital assets and cryptocurrencies. Eagle Investors does not currently charge a performance-based fee for any investment recommendations, including those related to digital assets and cryptocurrencies.
        </p>
        <p className="indent mt-2">
        ...
        <ul className="list-disc list-inside ml-4 mt-2">
          <li>Monthly: In a 30-day month, $127 per month is equivalent to $4.23/day</li>
          <li>Annual: In a 365-day year, $1,270 per year is equivalent to $3.48/day</li>
        </ul>
      </div>
      ...
      <div className="border-b border-slate-600 pb-4">
        ...
        <p className="indent">
          In the event of termination of this contract by either party or nonperformance by the Adviser, the Adviser shall refund to the Client a prorated portion of any prepaid fees for services not yet rendered for annual subscribers only.
        </p>
        <p className="indent mt-2">
...
export default InfinityContract;
