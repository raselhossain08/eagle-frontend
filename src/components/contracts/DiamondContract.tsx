...
export const DiamondContract: React.FC<DiamondContractProps> = ({
  customerName,
  contractDate,
  price,
  preview = false,
  ...
  return (
    <div className="contract-container  text-white text-sm space-y-4">
      ...
      <div className="border-b border-slate-600 pb-4">
        ...
        <p className="indent">
          The Fee will range from $76 monthly to $760 annually (not a % or for management but for the subscription). The fee includes recommendations of digital assets and cryptocurrencies. Eagle Investors does not currently charge a performance-based fee for any investment recommendations, including those related to digital assets and cryptocurrencies.
        </p>
        <p className="indent mt-2">
        ...
        <ul className="list-disc list-inside ml-4 mt-2">
          <li>Monthly: In a 30-day month, $76 per month would be equivalent to $2.53/day.</li>
          <li>Annual: In a 365-day year, $760 per year would be equivalent to $2.08/day.</li>
        </ul>
      </div>
