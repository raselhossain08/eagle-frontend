...
import { Check, Zap, Star, Gem, InfinityIcon } from "lucide-react";
...
export function PricingTiers() {
  ...
  const handleSubscriptionPurchase = (tier: any) => {
    if (tier.name === "Basic") {
  ...
  const tiers = [
    ...
    },
    {
      ...
      icon: InfinityIcon, // Changed to InfinityIcon
      gradient: "from-yellow-400 to-amber-600", // Gold gradient for icon background
      features: [
      ...
      href: "/pricing",
      popular: false, // Can set to true if it's the most premium/popular
      discount: "32%",
      annualDiscount: "43%",
      isInfinity: true, // Flag for special styling
    },
  ];
              ...
              >
                ...
                <CardContent className="flex flex-col flex-grow justify-between space-y-8 pb-8">
                  ...
                  <Button
                    ...
                    disabled={
                      tier.name !== "Basic" &&
                      hasSubscription(tier.name.toLowerCase())
                    }
